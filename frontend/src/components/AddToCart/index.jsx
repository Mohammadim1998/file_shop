...
const AddToCart = ({ data }) => {
    ...
    return (
        <div>
            <button onClick={cartAdder} className=" flex justify-center items-center text-center rounded-md p-2 w-full bg-orange-500 transition-all duration-300 hover:bg-orange-500 text-white">افزودن به سبد خرید</button>
            <ToastContainer
