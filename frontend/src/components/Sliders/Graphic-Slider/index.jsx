              ...
              <div className="flex flex-col gap-4 px-2">
                <header className="flex justify-between items-center">
                  ...
                  <div className="flex gap-1">
                    ...
                    <Link href={`/shop?&orderBy=date&type=gr&maxP=1000000000&minP=0&pgn=12&pn=1`} className="text-white border-white border-2 bg-indigo-500 px-4 py-2 rounded-md transition-all duration-500 hover:bg-indigo-600">مشاهده همه</Link>
                  </div>
