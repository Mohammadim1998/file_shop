...
router.post("/new-category",[
    ...
    check("title","تعداد کارکتر عنوان باید 5 تا 13 کارکتر باشد...").isLength({min:5, max:13}),
    check("shortDesc","تعداد کارکتر توضیحات کوتاه باید 5 تا 32 کارکتر باشد...").isLength({min:5, max:32}),
